    ...
    return function(canvas, menu, splash) {
        ...
        var menu = {
            ...
            run: function() {
                ...
                context.save();
                context.drawImage(menu.background, 0, 0);
                if(splash) {
            ...
            init: function() {
                menu.background = document.createElement("canvas");
                menu.background.width = canvas.width;
                menu.background.height = canvas.height;
                menu.background.getContext("2d").drawImage(canvas, 0, 0);
